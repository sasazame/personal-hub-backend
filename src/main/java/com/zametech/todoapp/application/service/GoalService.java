...
public class GoalService {
    ...
    public Goal updateGoal(String goalId, Goal goalUpdate) {
        UUID userId = userContextService.getCurrentUserId();
    ...
    public GoalWithTrackingResponse getGoalWithTracking(String goalId) {
    ...
    public ToggleAchievementResponse toggleAchievement(String goalId) {
        Goal goal = getGoalById(goalId);
        ...
        if (existingAchievement != null) {
            ...
            newAchievement.setId(UUID.randomUUID().toString());
